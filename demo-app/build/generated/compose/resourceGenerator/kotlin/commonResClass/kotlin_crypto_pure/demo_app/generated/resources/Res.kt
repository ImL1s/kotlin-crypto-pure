...
package kotlin_crypto_pure.demo_app.generated.resources
...
internal object Res {
  ...
  public suspend fun readBytes(path: String): ByteArray =
      readResourceBytes("composeResources/kotlin_crypto_pure.demo_app.generated.resources/" + path)
  ...
  public fun getUri(path: String): String =
      getResourceUri("composeResources/kotlin_crypto_pure.demo_app.generated.resources/" + path)
